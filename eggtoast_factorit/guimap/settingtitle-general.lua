...
rect = {
    {tag={},color={0,0,0},bg={0,0,0},pos={0,74},size={"dx",3}},
    {tag={"stencil"},color={0,0,0},bg={0,0,0},pos={0,149},size={"dx",3},slide=true},
    {tag={"stencil"},color={0,0,0},bg={0,0,0},pos={0,237},size={"dx",3},slide=true},
    {tag={"stencil"},color={0,0,0},bg={0,0,0},pos={0,337},size={"dx",3},slide=true}
},
recttxt = {
    {tag={},color={0,0,0},bg={1,1,1},text="#stng.general",pos={0,75},size={180,75},txc={0,0,0},txs={1.5,1.5},slide=false}
},
slider = {
    ...
    try = function ()
        ...
        if sttag == "stencil" then
            ...
            if sttag == "stenciloptionclick" then
                local dx,dy = love.graphics.getDimensions()
                love.graphics.rectangle("fill",0,150+math.max(-75,(-1*gui.script.sliderpos)),dx,dy)
            end
        end
    end,
